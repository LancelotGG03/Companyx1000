...
namespace CapaNegocio
{
    public class CN_Cliente
    {
        ...
        {
            Mensaje = string.Empty;
            string NuevaContraseña = CN_Recursos.GenerarClave();
            bool resultado = objCapaDato.ReestablecerClave(idcliente, CN_Recursos.ConvertirSha256(NuevaContraseña), out Mensaje);

            if (resultado)
            {
                string asunto = "Contraseña Reestablecida";

                string mensaje_correo = "<h3>Su cuenta fue reestablecida correctamente.</h3></br><p>Su contraseña para acceder ahora es: !Contraseña!</p>";

                mensaje_correo = mensaje_correo.Replace("!Contraseña!", NuevaContraseña);
